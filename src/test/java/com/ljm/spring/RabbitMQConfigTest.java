...
import com.ljm.spring.entity.Order;
import com.ljm.spring.entity.Packaged;
...
public class RabbitMQConfigTest {
    ...
    public void rabbitAdmin() throws Exception {
        ...
        rabbitAdmin.declareBinding(BindingBuilder.bind(
                ...
                to(new TopicExchange("test.topic", false, false)).//直接创建关联关系
                with("user.#"));//指定路由key

        rabbitAdmin.declareBinding(BindingBuilder.bind(
                new Queue("test.topic.queue", false)).//直接创建队列
                to(new FanoutExchange("test.topic", false, false)));//直接创建关联关系
    ...
    public void testSendMessage() throws Exception {
        ...
        rabbitTemplate.convertAndSend("topic001", "spring.amqp", message, new MessagePostProcessor() {
            ...
            public Message postProcessMessage(Message message) throws AmqpException {
                ...
                message.getMessageProperties().getHeaders().put("desc", "额外信息设置");
